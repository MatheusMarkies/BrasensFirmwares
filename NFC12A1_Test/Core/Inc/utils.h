...
#define WORD2ARRAY(w, a)    (memcpy((a), &(w), sizeof(uint16_t)))   /*!< Copy 16-bit unsigned to array */
#define DWORD2ARRAY(dw, a)  (memcpy((a), &(dw), sizeof(uint32_t)))  /*!< Copy 32-bit unsigned to array */
